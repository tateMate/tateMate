...
<body>
	...
	<hr>
<!-- 	user VO form  zone-->
	<form id="joinform" role="form" action="testJoinComplete" method="post" enctype="multipart/form-data">
		<div><table>
			<tr><td>*email:</td><td><input type="hidden" name="user_email" value="${email}">${email}</td></tr>
